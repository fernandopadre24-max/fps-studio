...
code = code.replace(
    /<input type="file" id="servicoImagem".*?onchange="previewImagem\(this, 'servicoImagemPreview'\)">.*?<img id="servicoImagemPreview".*?>/g,
...
code = code.replace(
    /<input type="file" id="materialImagem".*?onchange="previewImagem\(this, 'materialImagemPreview'\)">.*?<img id="materialImagemPreview".*?>/g,
